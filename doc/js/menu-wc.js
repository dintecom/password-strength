...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">@angular-material-extensions/password-strength documentation</a>
                </li>
                                ...
                                <a href="modules/MatPasswordStrengthModule.html" data-type="entity-link">MatPasswordStrengthModule</a>
                                    <li class="chapter inner">
                                        ...
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-MatPasswordStrengthModule-44a37946bee80ad4447949beaa6c12a6"' :
                                            ...
                                            <li class="link">
                                                <a href="components/MatPasswordStrengthComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">MatPasswordStrengthComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/MatPasswordStrengthInfoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">MatPasswordStrengthInfoComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
